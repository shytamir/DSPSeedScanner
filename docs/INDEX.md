...
- [SPEC-01 experiment record](specification/SPEC-01-EXPERIMENTS.md): Runtime
  observations supporting the generation-identity decision.
- [Runtime evidence feasibility](specification/RUNTIME-EVIDENCE-FEASIBILITY.md):
  Available runtime facts, collection stages, costs, and limitations.
- [Player seed-decision taxonomy](specification/PLAYER-DECISION-TAXONOMY.md):
  Player contexts, decision vocabulary, preferences, and disagreements.
- [Context-to-evidence matrix](specification/DECISION-EVIDENCE-MATRIX.md):
  Intersection of reproducible evidence with meaningful player decisions.
