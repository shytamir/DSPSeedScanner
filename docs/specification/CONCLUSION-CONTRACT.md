...
| `FS-GAS-ROUTE` | Which early-to-midgame giant-product opportunities exist? | Preview gas products and rates | Preserve product facts; present one starter-giant verdict: Fire Ice supports, Deuterium does not support. | No duplicate absence or Hydrogen verdict for that giant; never imply mineable deposits. |
