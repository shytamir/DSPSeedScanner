...
| `FS-RESOURCES` | `45772`: birth-system fire ice present; `73339583`: absent | These historical presence facts alone do not establish the amount/group adequacy rule. Absence **does not support**. |
