...
A game-version change alone no longer stops scanning. Unverified game
identities can produce results with a persistent red warning and red panel
borders. These results use current game evidence and the existing scanner
rules; their accuracy on the changed game has not been verified.
